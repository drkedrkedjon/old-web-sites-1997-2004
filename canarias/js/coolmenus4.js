...
function makeCM(name){
  var c=this; c.mc=0; c.name = name; c.m=new Array(); c.level=new Array(); c.l=new Array(); c.tim=100; 
...
makeCM.prototype.makeMenu=function(name,parent,txt,lnk,targ,w,h,img1,img2,cl,cl2,align,rows,nolink,onclick,onmouseover,onmouseout){
  ...
  if(img1){m.img1 = new Image(); m.img1.src=c.root+img1; m.img2 = new Image(); m.img2.src=c.root+img2;
    ...
    if(bw.dom&&!nolink) m.txt+='style="cursor:hand; cursor:pointer"'; if(!bw.reuse){if(!bw.dom) m.txt+='name="img'+m.name+'"'; m.txt+=' border="0"'}; m.txt+=' />'; if(!bw.reuse&&!nolink) m.txt+='</a>'
...
makeCM.prototype.showsub=function(el){
  ...
  if(!pm.b) pm.b=c.l[pm.lev].b; c.isover=1
  ...
  for(var i=0;i<c.l[l].m.length;i++){  
    ...
    if(m && m.parent==el&&!m.hide){
      ...
      if(bw.reuse){
        ...
        }else{o.evnt.onmouseover=''; o.evnt.onclick=''; o.css.cursor="auto"}
  ...
  if(!pm.subx||!pm.suby||c.srollY!=0) c.getcoords(pm,c.l[l-1].borderX,c.l[l-1].borderY,pm.b.x,pm.b.y,maxw,maxh,c.l[l-1].offsetX,c.l[l-1].offsetY)  
...
makeCM.prototype.hidesub=function(l,el){
  ...
  for(i=l-1;i<c.l.length;i++){
    ...
    if(c.l[i].a&&c.l[i].a!=el){
      ...
      if(i>0&&i>l-1) if(bw.op5||bw.op6) for(var j=0;j<c.l[i].m.length;j++) c.m[c.l[i].m[j]].o.hideIt()
...
makeCM.prototype.makeObjects=function(nowrite){
  ...
  for(i=0;i<c.l.length;i++){oc=0
    ...
    for(j=0;j<c.l[i].m.length;j++){
      ...
      if(j<c.l[i].arnum){
        c.l[i].arr[j]=new cm_makeObj(c.name+"_a"+i+"_"+j,nest+"_0",c.l[i].arr[j])
...
makeCM.prototype.construct=function(nowrite){
  ...
  switch(mp){
    ...
    bar1=c.bar1= new cm_makeObj(c.name+'bbar_0',c.name+'bbar',c.bar1)
    bar=c.bar= new cm_makeObj(c.name+'bbar','',c.bar); bar.css.zIndex=c.zIndex+1
...
function cm_resized(){
  ...
  if(page2.x2<cmpage.x2-off || page2.y2<cmpage.orgy-off || page2.x2>cmpage.x2+off || page2.y2>cmpage.orgy+off){
		if(bw.ie||bw.ns6){this.construct(1);
